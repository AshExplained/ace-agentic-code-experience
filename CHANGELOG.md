...
* **45.01:** update build-hooks, check-dist-sync, and tests to RENN naming ([1bc71a8](https://github.com/AshExplained/ace-agentic-code-experience/commit/1bc71a85956766ac1ea00289d339da9bf2f79009))
* **45.01:** update validate-markdown.js from ACE to RENN naming patterns ([1c6774e](https://github.com/AshExplained/ace-agentic-code-experience/commit/1c6774edf57192c066c1d84ab1dbd0df0c396391))
* **45.02:** rename ace/ directory and all 30 command files to renn ([8b61de5](https://github.com/AshExplained/ace-agentic-code-experience/commit/8b61de5e6e4ea94372c3bd8d73d5ad4b52b1343e))
* **45.02:** rename all 13 agent files and 4 hook files to renn ([de56bab](https://github.com/AshExplained/ace-agentic-code-experience/commit/de56babd47513255597f24002d19c4fad2c999b7))
* **45.05:** update all 18 workflow file contents from ace to renn ([f92be2f](https://github.com/AshExplained/ace-agentic-code-experience/commit/f92be2fcf0c99e373ad953d00fe0433de8658e15))
* **45.05:** update all template and reference file contents from ace to renn ([fee0143](https://github.com/AshExplained/ace-agentic-code-experience/commit/fee01437c30c3e487b89e98cbe9fd111aeb63683))
* **45.06:** update hooks and tests with RENN branding ([43f1133](https://github.com/AshExplained/ace-agentic-code-experience/commit/43f1133123fe69aa48c7fe860c23fb4f6f20ec21))
* **45.06:** update package.json and install.js with RENN branding ([e0bccab](https://github.com/AshExplained/ace-agentic-code-experience/commit/e0bccabdbec77a193f5afd0aa0d6f7ebc90dd733))
...
* **45.08:** replace remaining stale ACE references across 18 files ([7bbf912](https://github.com/AshExplained/ace-agentic-code-experience/commit/7bbf912bb39a1248e1bb0db2118d78aeee721f34))
...
* **45.04:** update agent frontmatter names and assign role-based colors ([210e02b](https://github.com/AshExplained/ace-agentic-code-experience/commit/210e02b77af66ae5b3cdcbe832735cf1399cb640))
* **45.07:** rebrand docs and ui-brand.md to RENN ([a4549fc](https://github.com/AshExplained/ace-agentic-code-experience/commit/a4549fce7b3ea3c98c47522b7f4a6560e02997d9))
* **45.07:** update AGENTS.md naming conventions and .gitignore to RENN ([15ac569](https://github.com/AshExplained/ace-agentic-code-experience/commit/15ac569d4d8d80de6de9045b95689e9c0e6eeaf6))
