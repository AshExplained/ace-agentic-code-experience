...
- Should align with the Core Value from brief.md
...
**Feature Dependencies:**
- Critical for track stage ordering
- If A requires B, B must be in an earlier stage
- Conflicts inform what NOT to combine in same stage
