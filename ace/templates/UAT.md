...
<!-- YAML format for plan-stage --gaps consumption -->
...
- `stage`: IMMUTABLE - set on creation
- `source`: IMMUTABLE - RECAP files being tested
...
**Resume after /clear:**
1. Read frontmatter -> know stage and status
